  ...
  useEffect(() => {
    ...
    supabase.auth.getUser().then(async ({ data }) => {
      ...
      if (data.user) {
        ...
        // Verifica se o usuário é dono de uma farmácia
            ...
            <div ref={menuRef} style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  height: "40px",
                  borderRadius: "50%",
                  backgroundColor: pharmacyName ? "#2E7D32" : "#D32F2F",
                  color: "#fff",
                  border: "none",
                  cursor: "pointer",
                  fontSize: "16px",
              ...
              {menuOpen && (
                ...
                >
                  <div style={{ padding: "14px 16px", borderBottom: "1px solid #f0f0f0" }}>
                    {pharmacyName ? (
                      <>
                        <p style={{ margin: 0, fontSize: "15px", fontWeight: 700, color: "#2E7D32" }}>
                          {pharmacyName}
                        </p>
                  ...
                  {pharmacyName && (
                    <button
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#f0faf0")}
